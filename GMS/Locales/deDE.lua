...
GMS:RegisterLocale("deDE", {
	...
	SETTINGS_NO_OPTIONS = "Keine konfigurierbaren Optionen für dieses Element gefunden.",
	...
	SETTINGS_SELECT_HINT = "Bitte wähle ein Modul oder eine Extension aus der Liste links aus.",

	DASHBOARD_STATUS_LOADED = "DASHBOARD: Systemstatus geladen",
	DASHBOARD_INFO_TITLE = "Allgemeine Informationen",
	DASHBOARD_GUILD_INFO_MISSING = "Keine Gildeninformationen verfügbar.",
	...
	PERM_TAB_RANKS = "Ränge & Rollen",
	PERM_TAB_PERMISSIONS = "Berechtigungen",
	PERM_TAB_SETTINGS = "Einstellungen",
	PERM_MEMBERS_IN_FMT = "Mitglieder in %s",
	PERM_ADD_PLAYER_LABEL = "Spieler hinzufügen (Name oder GUID)",
	PERM_SUGGESTIONS = "Vorschläge",
	...
	PERM_DELETE_GROUP = "Gruppe löschen",
	PERM_CREATE_NEW_GROUP = "Völlig neue Gruppe erstellen",
	PERM_NEW_GROUP_NAME = "Neue Gruppe",
	PERM_CAP_MODIFY_NAME = "Berechtigungen verwalten",
	PERM_CAP_MODIFY_DESC = "Ermöglicht das Erstellen, Umbenennen und Löschen von Gruppen sowie das Ändern von Berechtigungen.",
	...
	PERM_CAP_EDIT_ROSTER_DESC = "Ermöglicht das Bearbeiten von Notizen und Rängen innerhalb des GMS-Roster-Moduls.",
	...
	PERM_CAP_VIEW_LOGS_DESC = "Gewährt Zugriff auf detaillierte Addon-Logs und Historien.",
	...
	CHARINFO_CARD_EQUIPMENT = "Ausrüstung",
	CHARINFO_CARD_OVERVIEW = "Charakterübersicht",
	...
	CHARINFO_NO_MYTHIC_DATA = "Keine Mythic+-Daten für diesen Charakter verfügbar.",
	CHARINFO_NO_ACCOUNT_CHARS = "Derzeit keine verknüpften Account-Charaktere im Gildenroster verifiziert.",
	CHARINFO_ACCOUNT_CLICK_HINT = "Klicke auf einen Charakter, um CharInfo zu öffnen.",
	CHARINFO_LEVEL_SHORT_FMT = "Lv %d",
	CHARINFO_MYTHIC_ROW_FMT = "%s   Schlüssel: %s   Wertung: %s",
	...
	ROSTER_STATUS_BUSY = "Beschäftigt",
